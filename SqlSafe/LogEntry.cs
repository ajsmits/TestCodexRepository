...
namespace SqlSafe
{
    public sealed class LogEntry
    {
        ...
        public static async Task<int> GetNextBatchNumberAsync()
        {
            ...
            using var command = new SqlCommand("SqlSafe_LogExecution_GetNextBatch", connection)
            {
        ...
        public static async Task<IReadOnlyList<int>> GetBatchNumbersAsync()
        {
            ...
            using var connection = new SqlConnection(connectionString);
            using var command = new SqlCommand("SqlSafe_LogExecution_GetBatches", connection)
            {
                CommandType = CommandType.StoredProcedure
            };
            ...
            string? user = null)
        {
            ...
            using var connection = new SqlConnection(connectionString);
            using var command = new SqlCommand("SqlSafe_LogExecution_GetByBatch", connection)
            {
                CommandType = CommandType.StoredProcedure
            };
        ...
        public static async Task<int> InsertAsync(LogEntry entry)
        {
            ...
            using var connection = new SqlConnection(connectionString);
            using var command = new SqlCommand("SqlSafe_LogExecution_Insert", connection)
            {
                CommandType = CommandType.StoredProcedure
            };
